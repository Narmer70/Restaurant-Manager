...
{
    public partial class Foodgroupsinsert : Form
    {
        ...
        {
            this.Hide();
            Foodsubgroupinsert foodsubgroupinsert = new Foodsubgroupinsert();
            foodsubgroupinsert.ShowDialog();
        }
        ...
        private void InsertDataGridViewData()
        {
            ...
            try
            {
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    {
                        textBox1.Text = LanguageManager.Instance.GetString("FGI-Colinsert");
                        textBox1.ForeColor = Color.Tomato;
                        return;
                    }

                    if (!int.TryParse(row.Cells[0].Value.ToString(), out int groupId))
                    {
                    ...
                    string query = "INSERT INTO Groups (GroupID, GroupName) VALUES (@GroupID, @GroupName);";
        ...
        private void Foodgroupsinsert_Load(object sender, EventArgs e)
        {
            if (resizer != null)
            {
        ...
        private void Foodgroupsinsert_Resize(object sender, EventArgs e)
        {
            if (resizer != null)
            {
                resizer.ResizeControls(this);
        ...
        public void LocalizeControls()
        {
            ...
            label4.Text = LanguageManager.Instance.GetString("FI-lbl4");
