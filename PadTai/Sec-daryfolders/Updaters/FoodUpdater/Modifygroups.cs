    ...
    public partial class Modifygroups : UserControl
    {
        ...
        private void roundedTextbox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dataTable != null)
            {
                ...
                {
                    dataView.RowFilter = $"GroupName LIKE '%{filterExpression}%'";
                }
                else
                {
            ...
            if (e.RowIndex >= 0)
            {
                if (e.ColumnIndex == dataGridView1.Columns["Update"].Index)
                {
                    ...
                    if (selectedId != null)
                    {
                        ...
                        LoadGroupDetails(selectedId.ToString());
        ...
        {
            string query = $"SELECT GroupID, GroupName FROM Groups WHERE GroupID = '{groupId}'";

            DataTable groupDetails = crudDatabase.FetchDataFromDatabase(query);

            if (groupDetails.Rows.Count > 0)
            {
                roundedTextbox2.Text = groupDetails.Rows[0]["GroupID"]?.ToString() ?? "N/A";
                roundedTextbox3.Text = groupDetails.Rows[0]["GroupName"]?.ToString() ?? "N/A";
            }
            else
            {
        ...
        public void InsertGroup()
        {
            ...
            insertQuery = "INSERT INTO Groups (GroupName) VALUES (@name)";
            ...
            {
                this.Alert("Dish added successfully!", Alertform.enmType.Success);
                label18.Text = "Group inserted successfully!";
            ...
            {
                label18.Text = "Failed to insert group.";
                label18.ForeColor = Color.Tomato;
            }
        }
        ...
        public void UpdateGroup()
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (selectedId != null && int.TryParse(selectedId.ToString(), out int groupId))
                {
                    ...
                    string updateQuery = "UPDATE Groups SET GroupName = @name WHERE GroupID = @id";
                    var parameters = new Dictionary<string, object>
                    {
                        { "@id", groupId },
                        { "@name", roundedTextbox3.Text }
                    ...
                    {
                        label18.Text = "Group updated successfully!";
                        label18.ForeColor = Color.LawnGreen;
                        LoadGroupsTable();
                        clearControls();
                        rjButton1.Text = "Add dish";
                        ...
                        roundedPanel3.Visible = false;
                        rjButton1.BackColor = SystemColors.Highlight;
                        this.Alert("Group updated successfully!", Alertform.enmType.Success);
                    }
                    else
                    {
                        label18.Text = "Failed to update group.";
                        label18.ForeColor = Color.Tomato;
                    }
                }
                else
            ...
            {
                label18.Text = "Please select a group to update.";
                label18.ForeColor = Color.Tomato;
            }
        }
        ...
        public void DeleteGroup()
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (selectedId != null && int.TryParse(selectedId.ToString(), out int groupId))
                {
                    ...
                    string deleteQuery = "DELETE FROM Groups WHERE GroupID = @id";
                    var parameters = new Dictionary<string, object>
                    {
                        { "@id", groupId }
                    };
                    ...
                    {
                        label18.Text = "Group deleted successfully!";
                        label18.ForeColor = Color.LawnGreen;
                        LoadGroupsTable();
                        clearControls();
                        rjButton1.Text = "Add dish";
                        ...
                        roundedPanel3.Visible = false;
                        rjButton1.BackColor = SystemColors.Highlight;
                        this.Alert("Group deleted successfully!", Alertform.enmType.Success);
                    }
                    else
                    {
