...
{
    public partial class Modifytypes : UserControl
    {
        ...
        {
            string query = "SELECT * FROM FoodItemsTypes";
            ...
            else
            {
                ...
                label18.Text = "No types found.";
                label18.ForeColor = Color.Tomato;
            }
        }

        private void typesDGVColumns()
        {
        ...
        private void roundedTextbox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dataTable != null)
            {
                ...
                {
                    dataView.RowFilter = $"FooditemtypeName LIKE '%{filterExpression}%'";
                }
                else
                {
            ...
            if (e.RowIndex >= 0)
            {
                if (e.ColumnIndex == dataGridView1.Columns["Update"].Index)
                {
                    ...
                    if (selectedId != null)
                    {
                        ...
                        LoadtypeDetails(selectedId.ToString());
        ...
        private void LoadtypeDetails(string typeId)
        {
            string query = $"SELECT FooditemtypeID, FooditemtypeName FROM FoodItemsTypes WHERE FooditemtypeID = '{typeId}'";

            DataTable groupDetails = crudDatabase.FetchDataFromDatabase(query);

            if (groupDetails.Rows.Count > 0)
            {
                roundedTextbox2.Text = groupDetails.Rows[0]["FooditemtypeID"]?.ToString() ?? "N/A";
                roundedTextbox3.Text = groupDetails.Rows[0]["FooditemtypeName"]?.ToString() ?? "N/A";
            }
            else
            {
        ...
        public void Inserttype()
        {
            ...
            {
                label18.Text = "Please enter a type name.";
                label18.ForeColor = Color.Tomato;
                return;
            }
            ...
            // Insert without GroupID
            insertQuery = "INSERT INTO FoodItemsTypes (FooditemtypeName) VALUES (@name)";
            ...
            {
                this.Alert("Dish type added. Succes!", Alertform.enmType.Success);
                label18.Text = "Type inserted successfully!";
            ...
            {
                label18.Text = "Failed to insert type.";
                label18.ForeColor = Color.Tomato;
            }
        }
        ...
        public void Updatetype()
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (selectedId != null && int.TryParse(selectedId.ToString(), out int groupId))
                {
                    ...
                    string updateQuery = "UPDATE FoodItemsTypes SET FooditemtypeName = @name WHERE FooditemtypeID = @id";
                    var parameters = new Dictionary<string, object>
                    {
                        { "@id", groupId },
                        { "@name", roundedTextbox3.Text }
                    ...
                    {
                        label18.Text = "Type updated successfully!";
                        label18.ForeColor = Color.LawnGreen;
                        LoadtypeTable();
                        clearControls();
                        rjButton1.Text = "Add dish";
                        ...
                        roundedPanel3.Visible = false;
                        rjButton1.BackColor = SystemColors.Highlight;
                        this.Alert("Type updated successfully!", Alertform.enmType.Success);
                    }
                    else
                    {
                        label18.Text = "Failed to update type.";
                        label18.ForeColor = Color.Tomato;
                    }
                }
                else
                {
                    label18.Text = "Invalid type selected.";
                    label18.ForeColor = Color.Tomato;
                }
            }
            else
            {
                label18.Text = "Please select a type to update.";
                label18.ForeColor = Color.Tomato;
            }
        }
        ...
        public void Deletetype()
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (selectedId != null && int.TryParse(selectedId.ToString(), out int groupId))
                {
                    ...
                    string deleteQuery = "DELETE FROM FoodItemsTypes WHERE FooditemtypeID = @id";
                    var parameters = new Dictionary<string, object>
                    {
                        { "@id", groupId }
                    };
                    ...
                    {
                        label18.Text = "Type deleted successfully!";
                        label18.ForeColor = Color.LawnGreen;
                        LoadtypeTable();
                        clearControls();
                        rjButton1.Text = "Add dish";
                        ...
                        roundedPanel3.Visible = false;
                        rjButton1.BackColor = SystemColors.Highlight;
                        this.Alert("Type deleted successfully!", Alertform.enmType.Success);
                    }
                    else
                    {
                        label18.Text = "Failed to delete type.";
                        label18.ForeColor = Color.Tomato;
                    }
                }
                else
                {
                    label18.Text = "Invalid typeID selected.";
                    label18.ForeColor = Color.Tomato;
                }
            }
            else
            {
                label18.Text = "Please select a type to delete.";
                label18.ForeColor = Color.Tomato;
            }
        }
