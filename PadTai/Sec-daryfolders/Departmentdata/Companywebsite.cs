...
{
    public partial class Companywebsite : Form
    {
        ...
        private void Companywebsite_Load(object sender, EventArgs e)
        {
            if (resizer != null)
            {
        ...
        private void Companywebsite_Resize(object sender, EventArgs e)
        {
            if (resizer != null)
            {
                resizer.ResizeControls(this);
