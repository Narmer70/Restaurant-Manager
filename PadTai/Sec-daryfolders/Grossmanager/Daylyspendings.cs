...
{
    public partial class Daylyspendings : Form
    {
        private FontResizer fontResizer;
        private ControlResizer resizer;

        public Daylyspendings()
        {
            InitializeComponent();
        ...
        private void Daylyspendings_Load(object sender, EventArgs e)
        {
            if (resizer != null)
            {
        ...
        private void Daylyspendings_Resize(object sender, EventArgs e)
        {
            if (resizer != null)
            {
                resizer.ResizeControls(this);
